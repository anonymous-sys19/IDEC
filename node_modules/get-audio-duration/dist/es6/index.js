...
const ffprobe = __importStar(require("@ffprobe-installer/ffprobe"));
...
const getFFprobeWrappedExecution = (input, ffprobePath) => {
    ...
    return (0, execa_1.default)(overridenPath, [...params, input]);
};
/**
...
const getAudioDurationInSeconds = (absolutePathToFile, ffprobePath) => __awaiter(void 0, void 0, void 0, function* () {
    const { stdout } = yield getFFprobeWrappedExecution(absolutePathToFile, ffprobePath);
