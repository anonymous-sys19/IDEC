...
var ffprobe = __importStar(require("@ffprobe-installer/ffprobe"));
...
var getFFprobeWrappedExecution = function (input, ffprobePath) {
    ...
    return (0, execa_1.default)(overridenPath, __spreadArray(__spreadArray([], params, true), [input], false));
};
/**
 ...
 * seconds.
 */
var getAudioDurationInSeconds = function (absolutePathToFile, ffprobePath) { return __awaiter(void 0, void 0, void 0, function () {
    var stdout, matched;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getFFprobeWrappedExecution(absolutePathToFile, ffprobePath)];
            case 1:
